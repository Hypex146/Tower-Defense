...
TEST(Constructors, PosFull_0) {
    HeroAviation enemy(Position(1, 2), MyString("MyHero"), 90, 100, 3, 4, 5, 20, 30, BuffsAura());
    ...
    EXPECT_EQ(enemy.getType(), EntityType::HERO_AVIATION);
...
TEST(Constructors, XYFull_0) {
    HeroAviation enemy(1, 2, MyString("MyHero"), 90, 100, 3, 4, 5, 20, 30, BuffsAura());
    EXPECT_EQ(enemy.getAmmunition(), 30);
    EXPECT_EQ(enemy.getWallDamage(), 20);
    EXPECT_EQ(enemy.getMaxHP(), 100);
    EXPECT_EQ(enemy.getHP(), 90);
...
TEST(Constructors, PosNotFull_0) {
    HeroAviation enemy(Position(1, 2), MyString("MyHero"), 100, 3, 4, 5, 20, 30, BuffsAura());
    EXPECT_EQ(enemy.getAmmunition(), 30);
    EXPECT_EQ(enemy.getWallDamage(), 20);
    EXPECT_EQ(enemy.getMaxHP(), 100);
...
TEST(Constructors, XYNotFull_0) {
    HeroAviation enemy(1, 2, MyString("MyHero"), 100, 3, 4, 5, 20, 30, BuffsAura());
    EXPECT_EQ(enemy.getAmmunition(), 30);
    EXPECT_EQ(enemy.getWallDamage(), 20);
    EXPECT_EQ(enemy.getMaxHP(), 100);
    EXPECT_EQ(enemy.getHP(), 100);
...
TEST(Constructors, XYNotFullWithBuffs_0) {
    HeroAviation enemy(1, 2, MyString("MyHero"), 100, 3, 4, 5, 20, 30, BuffsAura(1, 2, 3, 4, 5));
    EXPECT_EQ(enemy.getAmmunition(), 30);
    EXPECT_EQ(enemy.getWallDamage(), 20);
    EXPECT_EQ(enemy.getMaxHP(), 100);
    EXPECT_EQ(enemy.getHP(), 100);
